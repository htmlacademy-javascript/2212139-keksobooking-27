...
function getRandomPositiveInteger(a, b) {
  // Если переданы отрицательные числа, возвращаем NaN
  if (a < 0 || b < 0) {
    return NaN;
  }
  ...
  // которое домножим на разницу между переданными числами плюс единица - это будет наша случайная дельта.
...
function getRandomPositiveFloat(a, b, digits = 1) {
  ...
  // Дальше используем Math.random() для получения случайного дробного числа в диапазоне [0, 1),
  // которое домножим на разницу между переданными числами - это будет наша случайная дельта.
  // После нужно сложить дельту с минимальным значением, чтобы получить итоговое случайное число.
